...
#Code to perform simulations to compare particles with buoy trajectories (buoy data from the NOAA Global Drifter Program 6-h)

#All the data needed to perform the simulations is in the data folder, add the corresponding paths

#To run this code you must have installed OpenDrift, you can place this script in the "examples" folder (https://opendrift.github.io/install.html)

#Created by: Ana Lucia de Santos Medina (https://github.com/luciadesanmed)

PATH_BOYAS = #add your data path
PATH_CURRENT = #add your data path
PATH_WIND = #add your data path
PATH_OUTPUT = #add your data path
...
for i, row in df_boya.iloc[::4].iterrows():
    ...
    # Seed 100 particles with wind factors from 0 to 0.05
    ...
    output_filename = os.path.join(PATH_OUTPUT,f'SK_boya1slastre_5km_dia{nn}.nc')
    ...
    # Define a distinct output filename for each 24h window
    output_filename = os.path.join(PATH_OUTPUT,f'SK_boya1slastre_1km_dia{nn}.nc')
...
for i, row in df_boya.iloc[::4].iterrows():
    ...
    # Define a distinct output filename for each 24h window
    output_filename = os.path.join(PATH_OUTPUT,f'SK_boya2slastre_1km_dia{nn}.nc')
...
for i, row in df_boya.iloc[::4].iterrows():
    ...
    # Define a distinct output filename for each 24h window
    output_filename = os.path.join(PATH_OUTPUT,f'SK_boya3slastre_5km_dia{nn}.nc')
    ...
    # Define a distinct output filename for each 24h window
    output_filename = os.path.join(PATH_OUTPUT,f'SK_boya3slastre_1km_dia{nn}.nc')
...
for i, row in df_boya.iloc[::4].iterrows():
    ...
    # Define a distinct output filename for each 24h window
    output_filename = os.path.join(PATH_OUTPUT,f'SK_boya4slastre_5km_dia{nn}.nc')
    ...
    # Define a distinct output filename for each 24h window
    output_filename = os.path.join(PATH_OUTPUT,f'SK_boya4slastre_1km_dia{nn}.nc')
...
for i, row in df_boya.iloc[::4].iterrows():
    ...
    # Define a distinct output filename for each 24h window
    output_filename = os.path.join(PATH_OUTPUT,f'SK_boya5slastre_5km_dia{nn}.nc')
    ...
    # Define a distinct output filename for each 24h window
    output_filename = os.path.join(PATH_OUTPUT,f'SK_boya5slastre_1km_dia{nn}.nc')
