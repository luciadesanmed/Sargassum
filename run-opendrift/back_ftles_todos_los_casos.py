...
#Script for performing simulations seeding on a regular grid - backwards
...
#TIMES:
rossby = datetime(2023, 4, 9, 0 ,0,0)
huracan = datetime(2022, 11, 11, 0, 0, 0)
junio = datetime(2023, 6, 20, 0, 0, 0)
calma = datetime(2022, 8, 17, 0, 0 , 0) 
...
o.run(duration=timedelta(days=10), time_step=timedelta(seconds=-300), time_step_output=timedelta(hours=12),outfile='calma5km_300s_ftles_back_55579_31-01-26.nc',export_variables=['time','status','lon','lat'])
print(o)
...
o1.run(duration=timedelta(days=10), time_step=timedelta(seconds=-300), time_step_output=timedelta(hours=12),outfile='calma1km_300s_ftles_back_55579_31-01-26.nc',export_variables=['time','status','lon','lat'])
print(o1)
...
o2.run(duration=timedelta(days=10), time_step=timedelta(seconds=-300), time_step_output=timedelta(hours=12),outfile='huracan5km_300s_ftles_back_55579_31-01-26.nc',export_variables=['time','status','lon','lat'])
print(o2)
...
o3.run(duration=timedelta(days=10), time_step=timedelta(seconds=-300), time_step_output=timedelta(hours=12),outfile='huracan1km_300s_ftles_back_55579_31-01-26.nc',export_variables=['time','status','lon','lat'])
print(o3)
...
o4.run(duration=timedelta(days=10), time_step=timedelta(seconds=-300), time_step_output=timedelta(hours=12),outfile='rossby5km_300s_ftles_back_55579_31-01-26.nc',export_variables=['time','status','lon','lat'])
print(o4)
...
o5.run(duration=timedelta(days=10), time_step=timedelta(seconds=-300), time_step_output=timedelta(hours=12),outfile='rossby1km_300s_ftles_back_55579_31-01-26.nc',export_variables=['time','status','lon','lat'])
print(o5)
...
o6.run(duration=timedelta(days=10), time_step=timedelta(seconds=-300), time_step_output=timedelta(hours=12),outfile='junio5km_300s_ftles_back_55579_31-01-26.nc',export_variables=['time','status','lon','lat'])
print(o6)
...
o7.run(duration=timedelta(days=10), time_step=timedelta(seconds=-300), time_step_output=timedelta(hours=12),outfile='junio1km_300s_ftles_back_55579_31-01-26.nc',export_variables=['time','status','lon','lat'])
print(o7)
